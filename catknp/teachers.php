...
$sql = "SELECT adno, filename FROM saved_images WHERE id = :id";
$stmt = $db->prepare($sql);
...
<body>
    ...
    <form action="submit_marks1.php" method="post">
    ...
    <script>
     ...
     fabric.Image.fromURL('up/<?php echo $img; ?>?v=<?php echo time(); ?>', function(img) {
    img.set({
    ...
    textBox.hiddenTextarea.focus();
          ...
          $(document).ready(function() {
                $("#save-image").click(function() {
                    ...
                    var adno = "<?php echo $img; ?>";
            
                    $.ajax({
                        type: "POST",
                        url: "test_save1.php", // This should be the path to your server-side script
                        data: { 
                            imageData: imageData,
                            adno: adno,
                        },
